    ...
    ">
        @foreach ($sets as $set)
            <div
                ...
                class="flex flex-col space-y-2 py-6 {{ $cols > 1 ? 'md:py-0' : '' }}"
            >
                <div x-on:click="show = true" class="font-bold flex space-x-2 cursor-pointer">
                    <div class="flex-grow">{{ $set->question }}</div>
