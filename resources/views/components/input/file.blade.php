<div
    x-cloak
    x-data="inputFile(@entangle('multiple'))" 
    x-show="show" 
        ...
        <div class="modal-content max-w-screen-sm p-5" x-on:click.stop>
            ...
            <div>
                @if ($currentTab === 'device')
                    <div x-data="inputFileDevice(@js($inputFileTypes), @js(config('atom.max_upload_size')))">
                        <div
