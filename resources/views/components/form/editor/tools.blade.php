<div class="group">
    ...
    <button type="button" x-tooltip="Blockquote" x-on:click="commands().toggleBlockquote()">
        <x-icon name="quote-left"/>
    </button>

    <button type="button" x-tooltip="Horizontal Rule" x-on:click="commands().setHorizontalRule()">
        <x-icon name="minus"/>
    </button>
</div>