<main class="min-h-screen">    
    <div 
        ...
        class="max-w-screen-xl mx-auto grid gap-12 px-4 py-20"
    >
                        ...
                        <div class="grid gap-4">
                            ...
                            @foreach ($this->relatedBlogs as $relatedBlog)
                                <x-blog.card size="sm"
                                    ...
                                    :excerpt="html_excerpt($relatedBlog->excerpt ?? $relatedBlog->content)"
                        ...
                        <div class="grid gap-4">
                            ...
                            @foreach ($this->recentBlogs as $recentBlog)
                                <x-blog.card size="sm"
                                    ...
                                    :excerpt="html_excerpt($recentBlog->excerpt ?? $recentBlog->content)"
                                    :date="$recentBlog->published_at"
                                />
                            @endforeach
                        </div>
                    @endif
