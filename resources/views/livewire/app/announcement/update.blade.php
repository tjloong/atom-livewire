...
@if ($announcement)
    ...
    <x-group cols="2">
        ...
        <x-form.date.datetime label="app.label.start-date" wire:model.defer="announcement.start_at"/>
        <x-form.date.datetime label="app.label.end-date" wire:model.defer="announcement.end_at"/>
        <x-form.color label="app.label.bg-color" wire:model.defer="announcement.bg_color"/>
        <x-form.color label="app.label.text-color" wire:model.defer="announcement.text_color"/>
    </x-group>
