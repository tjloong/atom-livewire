...
class InstallBakCommand extends Command
{
    protected $signature = 'atom:install
                            {module : Module to be installed. You must install base module first, then follow by other modules.}
                            {--static : Install static site.}
                            {--force : Force publishing.}';

    protected $description = 'Install Atom modules.';
